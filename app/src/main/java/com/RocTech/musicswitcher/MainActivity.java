...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //privacy protocol agreement
        privacyCompliance();
    }
    private void privacyCompliance() {
        MapsInitializer.updatePrivacyShow(MainActivity.this,true,true);
        SpannableStringBuilder spannable = new SpannableStringBuilder("\"Dear user, Thank you for supporting RocTech all along\n Now CLICK AGREE OR WE WILL SERVE YOU NO MORE!;\n");
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Click me", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        //start map after agreement
                        startActivity(new Intent(getApplicationContext(),
                                MapDisplay.class));
                    }
                })
                .setNegativeButton("Don't Click Me", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
